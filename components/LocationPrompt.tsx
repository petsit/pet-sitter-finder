...
// Only the primitive fields cross the server → client boundary. The
// full ServiceCategory contains an Icon component reference that React
// can't serialise as a prop, so the parent page extracts these instead.
interface Props {
  serviceLabel: string;
  serviceEmoji: string;
}
